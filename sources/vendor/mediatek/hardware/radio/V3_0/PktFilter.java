...
public final class PktFilter {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.address.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 24 + 0, false);
        this.mask = _hidl_blob.getString(_hidl_offset + 40);
        parcel.readEmbeddedBuffer(this.mask.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 40 + 0, false);
