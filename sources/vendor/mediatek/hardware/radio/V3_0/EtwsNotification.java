...
public final class EtwsNotification {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.plmnId.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
        this.securityInfo = _hidl_blob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer(this.securityInfo.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 32 + 0, false);
    }
