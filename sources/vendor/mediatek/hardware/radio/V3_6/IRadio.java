package vendor.mediatek.hardware.radio.V3_6;
...
import vendor.mediatek.hardware.radio.V3_0.IAtciIndication;
import vendor.mediatek.hardware.radio.V3_0.IAtciResponse;
import vendor.mediatek.hardware.radio.V3_0.IImsRadioIndication;
import vendor.mediatek.hardware.radio.V3_0.IImsRadioResponse;
import vendor.mediatek.hardware.radio.V3_0.IMwiRadioIndication;
import vendor.mediatek.hardware.radio.V3_0.IMwiRadioResponse;
import vendor.mediatek.hardware.radio.V3_0.ISERadioIndication;
import vendor.mediatek.hardware.radio.V3_0.ISERadioResponse;
...
import vendor.mediatek.hardware.radio.V3_5.ISubsidyLockIndication;
import vendor.mediatek.hardware.radio.V3_5.ISubsidyLockResponse;
/* loaded from: classes.dex */
public interface IRadio extends vendor.mediatek.hardware.radio.V3_5.IRadio {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio@3.6::IRadio";

    @Override // vendor.mediatek.hardware.radio.V3_5.IRadio, vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();

    @Override // vendor.mediatek.hardware.radio.V3_5.IRadio, vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements IRadio {
        ...
        @Override // vendor.mediatek.hardware.radio.V3_6.IRadio, vendor.mediatek.hardware.radio.V3_5.IRadio, vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio@3.6::IRadio]@Proxy";
            }
        }
        ...
        public void setResponseFunctionsMtk(vendor.mediatek.hardware.radio.V3_0.IRadioResponse radioResponse, vendor.mediatek.hardware.radio.V3_0.IRadioIndication radioIndication) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.radio.V3_0.IRadio.kInterfaceName);
            IHwBinder iHwBinder = null;
            _hidl_request.writeStrongBinder(radioResponse == null ? null : radioResponse.asBinder());
            if (radioIndication != null) {
                iHwBinder = radioIndication.asBinder();
        ...
        @Override // vendor.mediatek.hardware.radio.V3_3.IRadio
        public void notifyEPDGScreenState(int serial, int state) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.radio.V3_3.IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(state);
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(317, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override // vendor.mediatek.hardware.radio.V3_4.IRadio
        public void hangupWithReason(int serial, int callId, int reason) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.radio.V3_4.IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(callId);
            _hidl_request.writeInt32(reason);
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(318, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override // vendor.mediatek.hardware.radio.V3_5.IRadio
        public void setResponseFunctionsSubsidyLock(ISubsidyLockResponse sublockResp, ISubsidyLockIndication sublockInd) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.radio.V3_5.IRadio.kInterfaceName);
            IHwBinder iHwBinder = null;
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(319, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void sendSubsidyLockRequest(int serial, int reqType, ArrayList<Byte> data) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(320, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override // vendor.mediatek.hardware.radio.V3_6.IRadio, vendor.mediatek.hardware.radio.V3_5.IRadio, vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_5.IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_4.IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_3.IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_0.IRadio.kInterfaceName, android.hardware.radio.V1_2.IRadio.kInterfaceName, android.hardware.radio.V1_1.IRadio.kInterfaceName, android.hardware.radio.V1_0.IRadio.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-107, -9, 88, -87, 105, -24, 77, -48, -124, -112, 38, 108, -71, -44, -113, -87, 73, -59, 100, -94, 64, 30, -116, 78, -62, -58, 55, 85, 47, -102, -57, 108}, new byte[]{-7, -61, -69, -125, -90, -66, 49, -108, 82, -80, 27, -73, 104, -32, 59, -36, -84, 23, 102, -47, -40, -12, 99, 7, -92, 93, -56, -90, -56, -60, 100, 17}, new byte[]{-119, -42, 97, -28, -38, -27, 96, 20, -83, -20, 86, -67, 79, 85, -105, -34, 99, -62, 102, -46, 20, 32, 31, 95, 110, -86, -68, 41, 62, 25, -75, 73}, new byte[]{85, -98, 10, -26, -45, -30, -14, -123, -127, 12, -42, -12, -76, 12, 31, -100, -26, -114, -54, -26, -25, 96, -14, -15, -52, 36, -50, -86, 96, -10, -119, -88}, new byte[]{-52, -9, -76, -55, 88, -117, 5, 95, 74, 2, -86, -82, -118, 1, 48, -96, 123, -12, 82, -59, -72, -10, -41, -99, 59, 43, 118, 94, -21, -91, 21, -73}, new byte[]{-85, 19, 44, -103, 10, 98, -16, -84, -93, 88, 113, -64, -110, -62, 47, -71, -56, 93, 71, -114, 34, 18, 78, -10, -92, -48, -94, 48, 45, -89, 106, -97}, new byte[]{-9, -98, -33, 80, -93, 120, -87, -55, -69, 115, Byte.MAX_VALUE, -109, -14, 5, -38, -71, 27, 76, 99, -22, 73, 114, 58, -4, 111, -123, 108, 19, -126, 3, -22, -127}, new byte[]{-101, 90, -92, -103, -20, 59, 66, 38, -15, 95, 72, -11, -19, 8, -119, 110, 47, -64, 103, 111, -105, -116, -98, 25, -100, 29, -94, 29, -86, -16, 2, -90}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 143:
                    ...
                    _hidl_request.enforceInterface(vendor.mediatek.hardware.radio.V3_0.IRadio.kInterfaceName);
                    vendor.mediatek.hardware.radio.V3_0.IRadioResponse radioResponse2 = vendor.mediatek.hardware.radio.V3_0.IRadioResponse.asInterface(_hidl_request.readStrongBinder());
                    vendor.mediatek.hardware.radio.V3_0.IRadioIndication radioIndication2 = vendor.mediatek.hardware.radio.V3_0.IRadioIndication.asInterface(_hidl_request.readStrongBinder());
                ...
                case 317:
                    int reason3 = _hidl_flags & 1;
                    if (reason3 != 0) {
                        _hidl_index_0 = 1;
                    }
                    if (_hidl_index_0 == 1) {
                        _hidl_request.enforceInterface(vendor.mediatek.hardware.radio.V3_3.IRadio.kInterfaceName);
                        int serial310 = _hidl_request.readInt32();
                        int state5 = _hidl_request.readInt32();
                        notifyEPDGScreenState(serial310, state5);
                        break;
                    } else {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                ...
                case 318:
                    ...
                    if (_hidl_index_0 == 1) {
                        _hidl_request.enforceInterface(vendor.mediatek.hardware.radio.V3_4.IRadio.kInterfaceName);
                        int serial311 = _hidl_request.readInt32();
                        int callId6 = _hidl_request.readInt32();
                        int reason4 = _hidl_request.readInt32();
                        hangupWithReason(serial311, callId6, reason4);
                        break;
                    } else {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                ...
                case 319:
                    ...
                    if (_hidl_index_0 == 1) {
                        _hidl_request.enforceInterface(vendor.mediatek.hardware.radio.V3_5.IRadio.kInterfaceName);
                ...
                case 320:
                    ...
                    if (_hidl_index_0 == 1) {
                        _hidl_request.enforceInterface(vendor.mediatek.hardware.radio.V3_5.IRadio.kInterfaceName);
                        int serial312 = _hidl_request.readInt32();
                        int reqType = _hidl_request.readInt32();
                        ArrayList<Byte> data8 = _hidl_request.readInt8Vector();
                        sendSubsidyLockRequest(serial312, reqType, data8);
                        break;
                    } else {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
