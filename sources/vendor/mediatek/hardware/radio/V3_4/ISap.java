...
public interface ISap extends vendor.mediatek.hardware.radio.V3_3.ISap {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio@3.4::ISap";
    ...
    public static final class Proxy implements ISap {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio@3.4::ISap]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISap {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISap.kInterfaceName, vendor.mediatek.hardware.radio.V3_3.ISap.kInterfaceName, vendor.mediatek.hardware.radio.V3_2.ISap.kInterfaceName, vendor.mediatek.hardware.radio.V3_1.ISap.kInterfaceName, vendor.mediatek.hardware.radio.V3_0.ISap.kInterfaceName, android.hardware.radio.V1_2.ISap.kInterfaceName, android.hardware.radio.V1_1.ISap.kInterfaceName, android.hardware.radio.V1_0.ISap.kInterfaceName, IBase.kInterfaceName));
        }
