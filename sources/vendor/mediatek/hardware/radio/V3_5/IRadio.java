...
public interface IRadio extends vendor.mediatek.hardware.radio.V3_4.IRadio {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio@3.5::IRadio";

    @Override // vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();

    @Override // vendor.mediatek.hardware.radio.V3_4.IRadio, vendor.mediatek.hardware.radio.V3_3.IRadio, vendor.mediatek.hardware.radio.V3_0.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements IRadio {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio@3.5::IRadio]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_4.IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_3.IRadio.kInterfaceName, vendor.mediatek.hardware.radio.V3_0.IRadio.kInterfaceName, android.hardware.radio.V1_2.IRadio.kInterfaceName, android.hardware.radio.V1_1.IRadio.kInterfaceName, android.hardware.radio.V1_0.IRadio.kInterfaceName, IBase.kInterfaceName));
        }
