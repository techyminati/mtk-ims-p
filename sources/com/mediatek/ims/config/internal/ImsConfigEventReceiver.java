...
public class ImsConfigEventReceiver extends BroadcastReceiver {
    ...
    private static final String PROP_FORCE_DEBUG_KEY = "persist.log.mLogTag.tel_dbg";
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00da, code lost:
        if (r1.equals("READY") != false) goto L_0x00e8;
     */
    ...
    */
    ...
    private void updateFeatureSupportProperty(Bundle bundle) {
        ...
        sb.append("updateFeatureSupportProperty(), volte:");
        sb.append(isVolteOn ? RadioCapabilitySwitchUtil.IMSI_READY : "0");
        sb.append(" wfc:");
        sb.append(isWfcOn ? RadioCapabilitySwitchUtil.IMSI_READY : "0");
        sb.append(" vilte:");
        sb.append(isVilteOn ? RadioCapabilitySwitchUtil.IMSI_READY : "0");
        sb.append(" viwifi:");
        sb.append(isViWiFiOn ? RadioCapabilitySwitchUtil.IMSI_READY : "0");
        sb.append(" isRcsUaOn:");
        sb.append(isRcsUaOn ? RadioCapabilitySwitchUtil.IMSI_READY : "0");
    ...
    private void handleCarrierConfigChanged(Context context, Intent intent) {
        ...
        if (phoneId == this.mPhoneId) {
            ...
            if (tm == null || tm.hasIccCard(phoneId)) {
                ...
                String str = this.mLogTag;
                Rlog.d(str, "KEY_WFC_REMOVE_PREFERENCE_MODE_BOOL = " + removeWfcPrefMode);
                String str2 = this.mLogTag;
                Rlog.d(str2, "KEY_EDITABLE_WFC_MODE_BOOL = " + wfcModeEditable);
                if (removeWfcPrefMode || !wfcModeEditable) {
                    ...
                    Rlog.d(str3, "ACTION_CARRIER_CONFIG_CHANGED: set wfc mode = " + wfcMode + ", phoneId:" + phoneId);
                    ...
                    Rlog.d(str4, "no set wfc mode due to mims: " + ImsCommonUtil.supportMims() + ", main phone id:" + ImsCommonUtil.getMainPhoneIdForSingleIms());
                    return;
                }
                return;
            }
