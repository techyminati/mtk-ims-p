...
public final class SearchEngine implements Parcelable {
    ...
    public static final Parcelable.Creator<SearchEngine> CREATOR = new Parcelable.Creator<SearchEngine>() { // from class: com.mediatek.common.search.SearchEngine.1
    ...
    public static SearchEngine parseFrom(String configInfo, String sp) throws IllegalArgumentException {
        ...
        if (configInfo == null || MtkPhoneConstants.MVNO_TYPE_NONE.equals(configInfo)) {
            throw new IllegalArgumentException("Empty config info");
        }
        if (sp2 == null || MtkPhoneConstants.MVNO_TYPE_NONE.equals(sp2)) {
            sp2 = DEFAULT_SP;
        }
