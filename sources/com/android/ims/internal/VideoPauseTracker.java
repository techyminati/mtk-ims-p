...
public class VideoPauseTracker {
    ...
    private String sourcesToString(Collection<Integer> sources) {
        String str;
        synchronized (this.mPauseRequestsLock) {
            str = (String) sources.stream().map(new Function() { // from class: com.android.ims.internal.-$$Lambda$VideoPauseTracker$s27lPMyD4hPTfNQr9bbkfdTbLK8
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    String sourceToString;
                    sourceToString = VideoPauseTracker.this.sourceToString(((Integer) obj).intValue());
