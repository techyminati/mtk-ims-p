...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob3 = parcel.readEmbeddedBuffer(_hidl_vec_size3 * DataCallFailCause.APN_TYPE_CONFLICT, _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        this.lte.clear();
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            CellInfoLte _hidl_vec_element3 = new CellInfoLte();
            _hidl_vec_element3.readEmbeddedFromParcel(parcel, childBlob3, _hidl_index_03 * DataCallFailCause.APN_TYPE_CONFLICT);
        ...
        HwBlob childBlob5 = parcel.readEmbeddedBuffer(_hidl_vec_size5 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST, _hidl_blob.handle(), 0 + _hidl_offset + 88, true);
        this.tdscdma.clear();
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            ...
            _hidl_vec_element5.readEmbeddedFromParcel(parcel, childBlob5, _hidl_index_05 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob3 = new HwBlob(_hidl_vec_size3 * DataCallFailCause.APN_TYPE_CONFLICT);
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            this.lte.get(_hidl_index_03).writeEmbeddedToBlob(childBlob3, _hidl_index_03 * DataCallFailCause.APN_TYPE_CONFLICT);
        }
        ...
        HwBlob childBlob5 = new HwBlob(_hidl_vec_size5 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            this.tdscdma.get(_hidl_index_05).writeEmbeddedToBlob(childBlob5, _hidl_index_05 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
        }
