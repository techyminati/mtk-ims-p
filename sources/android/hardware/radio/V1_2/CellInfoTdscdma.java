...
public final class CellInfoTdscdma {
    ...
    public static final ArrayList<CellInfoTdscdma> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            CellInfoTdscdma _hidl_vec_element = new CellInfoTdscdma();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
    ...
    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob(VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfoTdscdma> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * VoiceCommandListener.VOICE_ERROR_TRAINING_PASSWORD_EXIST);
        }
