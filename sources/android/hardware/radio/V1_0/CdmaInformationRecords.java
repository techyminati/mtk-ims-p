...
public final class CdmaInformationRecords {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH, _hidl_blob.handle(), _hidl_offset + 0 + 0, true);
        this.infoRec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.infoRec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH);
        }
